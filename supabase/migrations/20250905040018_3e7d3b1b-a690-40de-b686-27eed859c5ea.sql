-- Drop triggers first, then recreate functions and triggers with proper security settings
DROP TRIGGER IF EXISTS increment_share_access_trigger ON public.assessment_instances;
DROP TRIGGER IF EXISTS increment_share_completion_trigger ON public.assessment_instances;
